...
const Founder = () => {
  ...
  return <section className="section-padding bg-card relative" ref={ref}>
      {/* Decorative line */}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          delay: 0.3
            ...
            <div className="w-40 h-40 md:w-52 md:h-52 mx-auto rounded-full overflow-hidden border-4 border-primary/30 shadow-2xl">
              <img alt="Jamel Ferjani - Fondateur d'Eva Managing" className="w-full h-full object-cover object-top" src="/lovable-uploads/ce97a8c1-52cd-4eb3-8637-13c103336a4a.jpg" />
            </div>
          </motion.div>
